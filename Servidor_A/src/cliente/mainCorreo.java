 ...
 * @author sebastian
 */
public class mainCorreo extends javax.swing.JFrame {
  ...
  int c =0;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mainCorreo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mainCorreo("").setVisible(true);
            }
        });
    }
